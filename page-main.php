...
<main class="main">
            ...
            <div class="container top-slider__container">
                <div class="top-slider__inner">
                    <div class="top-slider__item">
                        ...
                        <img class="top-slider__img" src="<?php echo get_template_directory_uri(); ?>/images/slider/foto.png" alt="slider image">
                    ...
                    <div class="info">
                        <div class="info__wrapper">
                            <div class="info__item">
                                ...
                                <p class="info__item-text">Lorem ipsum dolor sit amet, consectet adipiscing elit, sed do
                                </p>
                            </div>
                            <div class="info__item">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <div class="categories">
                            ...
                            <div class="categories__items">
                                ...
                                style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/content/cotegories/jewellry.jpg');">
                                ...
                                <div class="categories__item"
                                style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/content/cotegories/Clothes.jpg');">
                                ...
                                <div class="categories__item"
                                style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/content/cotegories/Men.jpg');">
                                    <p class="categories__item-subtitle">Trending Now</p>
                                    <h4 class="categories__item-title">Men’s Fashion</h4>
                                    <a class="categories__link" href="#">EXPLORE MORE</a>
                                </div>
                                <div class="categories__item"
                                style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/content/cotegories/Girl’s.jpg');">
            ...
            <div class="container">
                <div class="video-fashion__inner">
                    ...
                    <div class="video-fashion__content">
                        <p class="video-fashion__subtitle">Winter Collection 20% Off
                        </p>
                        <h3 class=" title video-fashion__title">TRENDING FASHION</h3>
                        <p class="text video-fashion__text">
                            ...
                            et
                            dolore magna aliqua.. Quis ipsum de ultcesm. Risus commodo viverra maecenas.</p>
                        <a class="video-fashion__link" href="#">V i e w <span>N o w</span></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="product">
            ...
            <!--////// -->
                    ...
                    <div class="product-item product-item--sale">
                        <div class="product-item__img-box product-item__images-icone">
                        <img class="product-item__images" src="<?php echo get_template_directory_uri(); ?>/images/product/4.jpg" alt="product">
                            <div class="product-item__link-box">
                                <a class="product-item__link" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="19px" height="20px">
                    ...
                    <div class="product-item">
                        <div class="product-item__img-box">
                        <img class="product-item__images" src="<?php echo get_template_directory_uri(); ?>/images/product/5.jpg" alt="product">
                            <div class="product-item__link-box">
                                <a class="product-item__link" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="19px" height="20px">
                    ...
                    <div class="product-item product-item--sale">
                        <div class="product-item__img-box">
                        <img class="product-item__images" src="<?php echo get_template_directory_uri(); ?>/images/product/6.jpg" alt="product">
                            <div class="product-item__link-box">
                                <a class="product-item__link" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="19px" height="20px">
