                    ...
                    <div class="info__wrapper">
                        ...
                        <?php while (have_rows('main__delivery')) : the_row(); ?>
                            <div class="info__item">
                                ...
                                <?php endif; ?>
                                <h5 class="info__item-title"><?php the_sub_field('delivery__title'); ?></h5>
                                <p class="info__item-text"><?php the_sub_field('delivery__text'); ?> </p>
                            </div>
                        <?php endwhile; ?>
                        <!-- info group -->
                    </div>
                                    ...
                                    <div class="categories__item">
                                        <a class="categories__link-shop" href="https://marcho/shop/">
                                            ...
                                            <div class="categories__item-box">
                                                <p class="categories__item-subtitle"><?php the_sub_field('categories__fashion-title'); ?></p>
                                                <h4 class="categories__item-title"><?php the_sub_field('categories__fashion-text'); ?></h4>
                                                <a class="categories__link" href="#"><?php the_sub_field('categories__fashion-link'); ?></a>
                                            </div>
                                        </a>
                                    </div>
                                <?php endwhile; ?>
        ...
        <div class="container">
            <div class="video-fashion__inner">
                <?php while (have_rows('main__video')): the_row(); ?>
                    ...
                    if ($image): ?>
                       <div class="video-fashion__popup" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/video-fashion.jpg');">
            ...
            <div class="product__items">
                ...
                <div class="product-item">
                    <div class="product-item__img-box">
                        <img class="product-item__images" src="<?php echo get_template_directory_uri(); ?>/images/product/1.jpg" alt="product">
                    ...
                    <div class="star" data-rateyo-rating="4">ffff</div>
                    <h4 class="product-item__title">White Polo Men’s T-Shirt</h4>
                    <div class="product-item__price">
                        <div class="product-item__new-price">$34.00</div>
                        <div class="product-item__old-price">$57.00</div>
                    </div>
                </div>
                <div class="product-item  product-item--sale">
                    <div class="product-item__img-box">
                        <img class="product-item__images" src="<?php echo get_template_directory_uri(); ?>/images/product/2.jpg" alt="product">
                        <div class="product-item__link-box">
                            <a class="product-item__link" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="19px" height="20px">
                ...
                <div class="product-item">
                    <div class="product-item__img-box">
                        <img class="product-item__images" src="<?php echo get_template_directory_uri(); ?>/images/product/3.jpg" alt="product">
                        <div class="product-item__link-box">
                            <a class="product-item__link" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="19px" height="20px">
    ...
    <div class="promo">
        <div class="container">
            <div class="promo__inner">
                ...
                <div class="promo__clock" data-time="'2022-10-30'">
    ...
    <div class="parners">
        <div class="container">
            <ul class="parners__list">
                <li class="parners__item"><img src="<?php echo get_template_directory_uri(); ?>/images/parners/1.png" alt="parners logo"></li>
                <li class="parners__item"><img src="<?php echo get_template_directory_uri(); ?>/images/parners/2.png" alt="parners logo"></li>
                <li class="parners__item"><img src="<?php echo get_template_directory_uri(); ?>/images/parners/3.png" alt="parners logo"></li>
                <li class="parners__item"><img src="<?php echo get_template_directory_uri(); ?>/images/parners/4.png" alt="parners logo"></li>
                <li class="parners__item"><img src="<?php echo get_template_directory_uri(); ?>/images/parners/5.png" alt="parners logo"></li>
                <li class="parners__item"><img src="<?php echo get_template_directory_uri(); ?>/images/parners/6.png" alt="parners logo"></li>
    ...
    <section class="blog">
        <div class="container">
            ...
            <div class="blog__items">
                <div class="blog__item">
                    ...
                    <div class="blog__item-box">
                        <div class="block-box">
                            ...
                            <div class="block-box__date">10 January, 2020</div>
                        </div>
                        <a class="blog__item-title-link" href="#">
                            <h4 class="blog__item-title">
                                Our Apps User Use moble On his Mobile
                            </h4>
                        </a>
                ...
                <div class="blog__item"> <a class="blog__item-imglink" href="#">
                ...
                <div class="blog__item"> <a class="blog__item-imglink" href="#">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/blog/3.jpg" alt="blog img">
